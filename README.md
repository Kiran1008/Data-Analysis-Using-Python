...
This project aims to analyze global cancer data to:

Identify patterns across age groups, gender, and cancer types

Evaluate relationships between lifestyle risk factors and cancer incidence
...
Identified patterns across age groups, gender distribution, and cancer types
...
Early-stage lung cancer detection patterns highlight opportunities for improved screening awareness programs.

Visualization-driven analysis helps reveal hidden trends in cancer distribution across demographics.
...
Build an interactive dashboard (Power BI / Tableau) for visualization

Expand dataset with multi-year global cancer statistics
